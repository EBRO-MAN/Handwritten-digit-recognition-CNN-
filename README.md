        ...
        # Selected Topics in Computer Science (CoSc4132)
...
## Project Overview
This project implements a Convolutional Neural Network (CNN)-based handwritten digit recognition system using the MNIST dataset. The goal is to demonstrate mastery of deep learning concepts, transfer learning readiness, and practical deployment using a user-friendly Gradio interface.
...
- Most importantly, this project serves as the **foundation for our upcoming final-year project**:

        ### *Rule-Based Sheep Breeding Expert System*
...
## Future Work
- Collect sheep ear-tag digit dataset  
- Apply transfer learning to adapt this model  
- Integrate into final Sheep Breeding Expert System  
- Deploy via Streamlit/Gradio as a farm-ready tool
